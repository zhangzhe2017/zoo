...
import com.alibaba.cardscanner.service.openapi.service.ServiceHelper;
...
public class IsvReceiveController {
    ...
    @RequestMapping("/isvreceivenew")
    public void isvReceive(HttpServletRequest request, HttpServletResponse response) throws IOException{
        /** url中的签名 **/
